...
bool DataBase::openDataBase()
{
    ...
    /*
     Сначала вы должны добавить соединение
     с базой данных с помощью addDatabase с типом драйвера QSQLITE и именем соединения,
     например MyConnection.

     Затем вы должны установить имя базы данных соединения и открыть его.

     В вашей папке разработки вы найдете \ android \ assets -
     просто поместите файл базы данных SQLite в эту папку и добавьте их в свой .pro:
